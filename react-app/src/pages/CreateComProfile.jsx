...
export default function CreateComProfile() {
    ...
    const clickHandler =async (e)=>{
        ...
        const user_type = currentUser.service_type
        ...
        try{
            ...
            const user = resData.data.id
            dispatch(profileSuccess({...currentUser,...formData,user}))
        ...
        <div className='flex-1 flex flex-col max-w-3xl m-auto mt-8 items-center shadow-lg rounded-lg py-8 bg-bg'>
            <form className='flex w-full flex-row items-center'>
                <div className="flex-1 flex flex-col items-center justify-center gap-7">
                    <p className="font-bold text-md mb-6">CREATE OWNER PROFILE</p>
                ...
                <div className="flex-1 px-10 mx-4">
                    <div className="flex flex-col gap-4 items-center">
                        <input id="name" type="text"
                            placeholder='Name'
                            className="w-full bg-F0EFFF placeholder-gray-400 border border-none rounded-md p-2 placeholder:text-xs text-xs text-black" onChange={formHandler}></input>
                        <input
                            id="phoneNo"
                            type="text"
